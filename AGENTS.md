...
- `Dockerfile.dev/` — explain what lives here and when agents should edit it.
...
- `files/` — explain what lives here and when agents should edit it.
- `nest-cli.json/` — explain what lives here and when agents should edit it.
